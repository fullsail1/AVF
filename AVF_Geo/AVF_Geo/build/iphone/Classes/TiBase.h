...
// in simulator we redefine to format for AVF_Geo Developer console
...
{\
	NSString * exceptionName = [@"org.avf_geo." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.avf_geo";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAVF_GeoNativeItemNone = -1, 
	UIAVF_GeoNativeItemSpinner = -2,
	UIAVF_GeoNativeItemProgressBar = -3,
	
	UIAVF_GeoNativeItemSlider = -4,
	UIAVF_GeoNativeItemSwitch = -5,
	UIAVF_GeoNativeItemMultiButton = -6,
	UIAVF_GeoNativeItemSegmented = -7,
	
	UIAVF_GeoNativeItemTextView = -8,
	UIAVF_GeoNativeItemTextField = -9,
	UIAVF_GeoNativeItemSearchBar = -10,
	
	UIAVF_GeoNativeItemPicker = -11,
	UIAVF_GeoNativeItemDatePicker = -12,
	
	UIAVF_GeoNativeItemInfoLight = -13,
	UIAVF_GeoNativeItemInfoDark = -14,
	
	UIAVF_GeoNativeItemDisclosure = -15,
	
	UIAVF_GeoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AVF_Geo instances of
