...
//@interface AVF_GeoObject : NSObject
//@end

@interface AVF_GeoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AVF_GeoObject class]])
		{
			for (NSString *key in [[(AVF_GeoObject*)o modules] allKeys])
			{
