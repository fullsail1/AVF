...
/**
 The base class for all music modules
 */
...
/**
 music Platform calls this method on startup.
 */
-(void)startup;

/**
 music Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 music Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 music Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 music Platform calls this method on resume.
 @param sender The sender of the event.
 */
