...
// in simulator we redefine to format for music Developer console
...
{\
	NSString * exceptionName = [@"org.music." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.music";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UImusicNativeItemNone = -1, 
	UImusicNativeItemSpinner = -2,
	UImusicNativeItemProgressBar = -3,
	
	UImusicNativeItemSlider = -4,
	UImusicNativeItemSwitch = -5,
	UImusicNativeItemMultiButton = -6,
	UImusicNativeItemSegmented = -7,
	
	UImusicNativeItemTextView = -8,
	UImusicNativeItemTextField = -9,
	UImusicNativeItemSearchBar = -10,
	
	UImusicNativeItemPicker = -11,
	UImusicNativeItemDatePicker = -12,
	
	UImusicNativeItemInfoLight = -13,
	UImusicNativeItemInfoDark = -14,
	
	UImusicNativeItemDisclosure = -15,
	
	UImusicNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all music instances of
